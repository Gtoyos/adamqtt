...
public class TempClient {//synchronous client
	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    try(
            ...
            while(true){
                ...
                mqttClient.publish("/home/Lyon/sido/dht22/value2", new MqttMessage(messageContent2.getBytes()));
                Thread.sleep(1000);
            }
	    }
